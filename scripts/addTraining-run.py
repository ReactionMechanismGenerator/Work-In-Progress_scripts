...
n=[3.27,3.24,3.27,3.13,3.22,3.28,3.30,3.22,3.09,3.12,3.12,3.08,2.92,2.73,2.95,2.93,2.84,2.863.21,2.84,3.31,3.29,2.90,2.91,2.80,2.90,2.93,3.42]
Ea=[6.85,7.03,7.15,7.32,7.04,6.73,6.48,5.48,5.73,5.82,5.78,6.18,4.37,4.91,5.32,5.24,4.01,3.72,3.77,5.77,5.63,5.46,5.72,3.45,4.67,3.38,5.06,2.93,8.66]
reactant1smiles=['CC=CC', 'CC=CCC', 'C=CC', 'C=C(C)CC'. 'C=C(C)C', 'CC=C(C)C', 'CC=C(C)C', 'C=CCC=C', 'CC=CCC', 'C=CCC', 'C=CCC', 'C=C(C)CC', 'C=CC(C)CC', 'C1C=CCC1', 'C1C=CCCC1', 'CC1=CCCC1', 'CC1=CCCCC1', 'C=CCC=C', 'C=CC=CC=' 'C=CC(C)=CC', 'C=CC=C(C)C', 'C1=CCC=CC1', 'C1=CC=CCC', 'CC1=CC=CC', 'C1=CC=CC', 'c1ccccc1', 'c1cccc1']
reactant2smiles=['CH3']*28
degeneracy=[6,3,3,3,6,3,3,4,2,2,2,2,1,1,4,4,1,1,2,3,3,6,4,4,1,2,6,3]

addTraining(family,A,n,Ea,degeneracy,reactant1smiles,
