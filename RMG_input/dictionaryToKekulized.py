...
of aromatic species to the Kekulized (single-double bond) form.
"""

import argparse
from rmgpy.species import Species
from rmgpy.chemkin import loadSpeciesDictionary, saveSpeciesDictionary
from rmgpy.molecule.resonance import generateKekulizedResonanceIsomers
    ...
    with open(inputPath, 'r+b') as f:
        ...
        for line in f:
            if line.strip() == '' and adjlist.strip() != '':
                ...
                aromatic = generateKekulizedResonanceIsomers(species.molecule[0])
                if aromatic:
